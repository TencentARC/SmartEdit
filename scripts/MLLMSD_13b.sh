...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_addr 127.0.0.1 --master_port 28457 fastchat/train/DS_MLLMSD11_train.py \
    --max_steps 5000 \
    ...
    --bf16 True \
    --tf32 True \
    --output_dir ./checkpoints/stage2_MLLMSD_13b \
    --num_train_epochs 20 \
    ...
    --SD_QFormer_conversation_33tokens "./checkpoints/stage1_CC12M_alignment_13b/embeddings_qformer/checkpoint-150000_embeddings_qformer.bin" \
