...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_addr 127.0.0.1 --master_port 28458 train/DS_SmartEdit_train.py \
    --max_steps 15000 \
    --model_name_or_path ./checkpoints/vicuna-13b-v1-1 \
    --LLaVA_00001 "./checkpoints/LLaVA-13B-v1/pytorch_model-00001-of-00003.bin" \
    --LLaVA_00002 "./checkpoints/LLaVA-13B-v1/pytorch_model-00003-of-00003.bin" \
    --LLaVA_model_path "./checkpoints/LLaVA-13B-v1" \
    --sd_qformer_version "v1.1-13b" \
    --pretrained_LLaMA "./checkpoints/stage2_MLLMSD_13b/LLM-5000/adapter_model.bin" \
    --pretrained_model "./checkpoints/stage2_MLLMSD_13b/embeddings_qformer/checkpoint-5000_embeddings_qformer.bin" \
    --pretrained_unet "./checkpoints/stage2_MLLMSD_13b/unet-5000/adapter_model.bin" \
    --bf16 True \
    --tf32 True \
    --output_dir "./checkpoints/SmartEdit_13b_ckpt" \
    --num_train_epochs 20 \
