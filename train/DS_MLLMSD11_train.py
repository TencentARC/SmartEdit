""" SmartEdit training for MLLM-SD """
...
class ModelArguments:
    ...
    SD_QFormer_conversation_33tokens: str = "./LLMSD_exp/LLaVA_11_7b_CC12M_alignment/embeddings_qformer/checkpoint-100000.bin"
    ...
    unet_ckpt: str = "./InstructDiffusion_diffusers/unet/diffusion_pytorch_model.bin"
...
class DataCollatorForLLaVADataset(object):
    ...
    def __call__(self, instances: Sequence[Dict]) -> Dict[str, torch.Tensor]:
        ...
        # for LLaVA processing -> LLM tokenizer
...
def train():
    ...
    if sd_qformer_version == "v1.1-7b" or "v1.1-13b":
        ...
        print(SD_QFormer_conversation_33tokens, LLaVA_00002)
    ...
    unet_weights = torch.load(model_args.unet_ckpt, map_location="cpu")
    model_.unet.load_state_dict(unet_weights, strict=True)
    model_.unet.requires_grad_(True)
    print('Loading InstructDiffusion unet checkpoint:', model_.unet.load_state_dict(unet_weights, strict=True))
