""" SmartEdit inference for MLLM-SD """
...
########################################################################################################################################################################
def get_prompt_embedding_LLM(img_embeddings, text_prompt, conversation_template, LLM_tokenizer, model_, condition_prompt='positive'):
...
from model.DS_MLLMSD11_model import MLLMSD_model
...
def main():
    ...
    # Load MLLMSD_model
    model_ = MLLMSD_model.from_pretrained(
        model_name_or_path,
        cache_dir=None
    )
        ...
        for sub_dir in benckmark_understanding_scenes_dir:
            ...
            for idx, img_path in enumerate(test_img_list):
                ...
                both_condition_embeddings = \
                    generate_LLaVA_image(CLIP_image_features_llm_input, text_prompt, LLM_tokenizer, model_)
    ...
    if is_reasoning_scenes == 'True':
        image_SD_reasoning, both_reasoning = [], []
        ReasonEdit_benckmark_dir = args.ReasonEdit_benckmark_dir
        ...
        for idx, img_path in enumerate(test_img_list):
            ...
            original_image_for_SD = original_image_for_SD.convert("RGB")
            print(img_path)
            both_condition_embeddings = generate_LLaVA_image(CLIP_image_features_llm_input, text_prompt, LLM_tokenizer, model_)
...
########################################################################################################################################################################
"""
# execute DS_MLLMSD11_test.py
* RE-1. is_understanding_scenes
CUDA_VISIBLE_DEVICES=0 python test/DS_MLLMSD11_test.py --is_understanding_scenes True --model_name_or_path "vicuna-7b-v1-1" --LLaVA_model_path "./LLaVA-7B-v1" --save_dir './stage2_MLLMSD_7b/Understand-5000' --steps 5000 --total_dir "./checkpoints/stage2_MLLMSD_7b" --ReasonEdit_benckmark_dir "./ReasonEdit_benckmark_dir" --sd_qformer_version "v1.1-7b"
CUDA_VISIBLE_DEVICES=0 python test/DS_MLLMSD11_test.py --is_understanding_scenes True --model_name_or_path "vicuna-7b-v1-1" --LLaVA_model_path "./LLaVA-7B-v1" --save_dir './stage2_MLLMSD_7b/Understand-384-5000' --steps 5000 --total_dir "./checkpoints/stage2_MLLMSD_7b" --ReasonEdit_benckmark_dir "./ReasonEdit_benckmark_dir" --sd_qformer_version "v1.1-7b" --resize_resolution 256
* RE-2. is_reasoning_scenes
CUDA_VISIBLE_DEVICES=0 python test/DS_MLLMSD11_test.py --is_reasoning_scenes True --model_name_or_path "vicuna-7b-v1-1" --LLaVA_model_path "./LLaVA-7B-v1" --save_dir './stage2_MLLMSD_7b/Reason-5000' --steps 5000 --total_dir "./checkpoints/stage2_MLLMSD_7b" --ReasonEdit_benckmark_dir "./ReasonEdit_benckmark_dir" --sd_qformer_version "v1.1-7b"
CUDA_VISIBLE_DEVICES=0 python test/DS_MLLMSD11_test.py --is_reasoning_scenes True --model_name_or_path "vicuna-7b-v1-1" --LLaVA_model_path "./LLaVA-7B-v1" --save_dir './stage2_MLLMSD_7b/Reason-384-5000' --steps 5000 --total_dir "./checkpoints/stage2_MLLMSD_7b" --ReasonEdit_benckmark_dir "./ReasonEdit_benckmark_dir" --sd_qformer_version "v1.1-7b" --resize_resolution 384
"""
